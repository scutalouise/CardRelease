...
<OBJECT id=rd codeBase=${pageContext.request.contextPath }/comRD800.dll classid="clsid:638B238E-EB84-4933-B3C8-854B86140668"></OBJECT>
</head>
<body>
	<a href="toRelease">连接到发卡页面去</a>
	<br><br>
	读取到的卡号：
	<input type="text" name="cardno" id="cardno">
	<br><br>
	<input type="button" value="读取卡号" id="read">

						...
						<form:form action="${pageContext.request.contextPath }/customer/addCustomer" cssClass="form-horizontal" method="post" modelAttribute="customer" id="customerFrom">
							<fieldset>
							  ...
							  <div class="control-group" id="invalidDIV">
								...
								<div class="controls">
								  <input type="text" id="invalid" class="input-xlarge focused" name="invalid"  onclick="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd',doubleCalendar:true,minDate:'{%y+1}-%M-%d',readOnly:true})" >
								  <span class="help-inline">格式为：2015-01-01;默认时间为1年以后；</span>
								</div>
							  </div>

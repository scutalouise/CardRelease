							...
							<fieldset>
							  <div class="control-group warning"  id="lossCardNoDIV" >
								...
								<div class="controls">
								  ...
								  <span class="help-inline" id="lossCardNoSPAN"></span>
							...
							<fieldset>
							  <div class="control-group warning" id="cancelLossReadCardNoDIV">
								...
								<div class="controls">
								  ...
								  <span class="help-inline" id="cancelLossCardNoSPAN"></span>
							...
							<fieldset>
							  ...
							  <div class="control-group warning" id="reReleaseReadNewCardNoDIV">
								...
								<div class="controls">
								  ...
								  <span class="help-inline" id="reReleaseNewCardNoSPAN"></span>
								  <button type="button" class="btn btn-primary" id="reReleaseReadNewCardNo">读新体验卡信息</button>
								</div>
							  </div>
							  <div class="form-actions" id="reReleaseDIV">

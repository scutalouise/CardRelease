package org.apache.jsp.WEB_002dINF.views.release;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class cardRelease_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t\t<h2><i class=\"icon-edit\"></i> 发卡</h2>\n");
      ...
      out.write("\t\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"control-group warning\"  id=\"cardno_div\" >\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputWarning\" >请录入卡号</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t  <input type=\"text\" id=\"inputWarning\">\n");
      out.write("\t\t\t\t\t\t\t\t  <span class=\"help-inline\">卡号要求为6位整数</span>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"form-actions\">\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" id=\"releaseCard\">发    卡</button>\n");
      out.write("\t\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t\t\t  </form>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<div class=\"box span12\">\n");
      out.write("\t\t\t\t\t<div class=\"box-header well\" data-original-title>\n");
      out.write("\t\t\t\t\t\t<h2><i class=\"icon-edit\"></i> 读卡</h2>\n");
      out.write("\t\t\t\t\t\t<div class=\"box-icon\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-minimize btn-round\"><i class=\"icon-chevron-up\"></i></a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-close btn-round\"><i class=\"icon-remove\"></i></a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<form class=\"form-horizontal\">\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"control-group warning\" id=\"readCard\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputWarning\">当前卡号</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t  <input class=\"input-xlarge disabled\" id=\"disabledInput\" type=\"text\" disabled=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"form-actions\">\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\">读取卡信息</button>\n");
      out.write("\t\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<div class=\"box span12\">\n");
      out.write("\t\t\t\t\t<div class=\"box-header well\" data-original-title>\n");
      out.write("\t\t\t\t\t\t<h2><i class=\"icon-edit\"></i> 卡还原</h2>\n");
      out.write("\t\t\t\t\t\t<div class=\"box-icon\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-minimize btn-round\"><i class=\"icon-chevron-up\"></i></a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-close btn-round\"><i class=\"icon-remove\"></i></a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"form-actions\">\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" id=\"recovery\">卡片还原</button>\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/card_js/releaseCard.js\" defer=\"defer\"></script>\n");
      out.write("</body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {

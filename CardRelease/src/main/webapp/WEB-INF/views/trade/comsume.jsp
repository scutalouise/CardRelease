			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 体验卡卡消费扣点</h2>
						<div class="box-icon">
						...
						<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath }/trade/comsume" method="post" modelAttribute="tradePoint">
							<fieldset>
							  <div class="control-group" id="readCardDIV">
								<label class="control-label" for="focusedInput">*VIP卡号</label>
								<div class="controls" >
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">*消费前点数</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="ptBefore" readonly="readonly" type="text" value="${requestScope.customer.ptBefore}" name="ptBefore">
								  <span class="help-inline"></span>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">*当前扣减点数</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="ptTrade" type="text" value="1" name="ptTrade" readonly="readonly">
								  <span class="help-inline"></span>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">*消费后剩余点数</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="ptAfter" readonly="readonly" type="text" value="${requestScope.customer.ptAfter}" name="ptAfter">
								  <span class="help-inline"></span>
								</div>
							  </div>
							  <div class="form-actions">
								<button type="button" class="btn btn-primary" id="comsumeButton">扣减VIP卡</button>

				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header well" data-original-title>
							<h2><i class="icon-edit"></i> 新加系统功能</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath }/authority/addFunction" method="post" modelAttribute="function" name="function">
								<fieldset>
								  <div class="control-group" id="functionNameDIV">
									<label class="control-label" for="focusedInput">*系统功能名字</label>
									<div class="controls">
									  <input class="input-xlarge focused" id="functionName" type="text" value="" name="functionName">
								  ...
								  <div class="control-group">
									...
									<div class="controls">
									  <label class="radio">
										<input type="radio" name="state" id="optionsRadios2" value="1" checked="checked">
										生效
									  </label>
									  <div style="clear:both"></div>
									  <label class="radio">
										<input type="radio" name="state" id="optionsRadios1" value="0" >
										不生效
									  </label>
									</div>
								  </div>
								  <div class="control-group" id="urlDIV">
									...
									<div class="controls">
									  <input class="input-xlarge focused" id="url" type="text" value="" name="url">
									  <span class="help-inline">例如：/basedata</span>
									</div>
								  </div>
								  <div class="form-actions">
									<button type="button" class="btn btn-primary" id="save">保存功能</button>
